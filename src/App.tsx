...
export default function App() {
  return (
    <section className='mt-4 sm:mt-8 w-full max-w-screen-md mx-auto'>
      ...
      <Tabs defaultValue="split" className="mt-4">
        ...
        <TabsContent value="split">Make changes to your account here.</TabsContent>
        <TabsContent value="merge">Change your password here.</TabsContent>
        <TabsContent value="ocr">Change your password here.</TabsContent>
      </Tabs>
    </section>
  )
}
